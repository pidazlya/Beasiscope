...
foreach ($scholarships as &$scholarship) {
    $words = explode(' ', $scholarship['persyaratan']);
    $scholarship['persyaratan_preview'] = implode(' ', array_slice($words, 0, 3)) . (count($words) > 5 ? '...' : '');
}
            ...
            <nav>
                <ul>
                    <li><a href="Dashboard.php"
                            class="<?= basename($_SERVER['PHP_SELF']) == 'Dashboard.php' ? 'active' : '' ?>">Dashboard</a>
                    </li>
                    <li><a href="#" class="active">Manajemen Beasiswa</a></li>
                    <li><a href="KategoriBeasiswa.php"
                            class="<?= basename($_SERVER['PHP_SELF']) == 'KategoriBeasiswa.php' ? 'active' : '' ?>">Kategori
                            Beasiswa</a></li>
                    <li><a href="ManajemenInformasi.php"
                            class="<?= basename($_SERVER['PHP_SELF']) == 'ManajemenInformasi.php' ? 'active' : '' ?>">Manajemen
                            Informasi</a></li>
                    <li><a href="ManajemenTestimoni.php"
                            class="<?= basename($_SERVER['PHP_SELF']) == 'ManajemenTestimoni.php' ? 'active' : '' ?>">Manajemen
                            Testimoni</a></li>
                </ul>
            </nav>
        </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($scholarships as $scholarship): ?>
                                <tr>
                                    ...
                                    <td><?php echo $scholarship['persyaratan_preview']; ?></td>


                                    <td><span
                                            class="status-badge <?php echo strtolower($scholarship['status']); ?>"><?php echo $scholarship['status']; ?></span>
                                    </td>
                                    <td class="actions">
                                        <button class="view-btn"
                                            onclick="viewScholarship(<?php echo $scholarship['id']; ?>)">View</button>
                                        <button class="edit-btn"
                                            onclick="editScholarship(<?php echo $scholarship['id']; ?>)">Edit</button>
                                        <button class="delete-btn"
                                            onclick="if(confirm('Hapus beasiswa ini?')) { window.location.href='?action=delete&id=<?php echo $scholarship['id']; ?>'; }">Hapus</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
